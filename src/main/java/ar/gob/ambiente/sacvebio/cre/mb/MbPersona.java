...
import ar.gob.ambiente.sacvebio.cre.rue.client.PersonaClient;
import ar.gob.ambiente.sacvebio.cre.rue.client.TipoEntidadClient;
import ar.gob.ambiente.sacvebio.cre.rue.client.TipoSociedadClient;
import ar.gob.ambiente.sacvebio.cre.territ.client.DepartamentoClient;
import ar.gob.ambiente.sacvebio.cre.territ.client.LocalidadClient;
import ar.gob.ambiente.sacvebio.cre.territ.client.ProvinciaClient;
import ar.gob.ambiente.sacvebio.cre.territ.client.UsuarioClient;
import ar.gob.ambiente.sacvebio.cre.util.EntidadServicio;
import ar.gob.ambiente.sacvebio.cre.util.JsfUtil;
import ar.gob.ambiente.sacvebio.cre.util.Token;
...
public class MbPersona implements Serializable {
     ...
     */
    private ar.gob.ambiente.sacvebio.cre.entities.Domicilio domicilioLocal;
     ...
     */
    private ar.gob.ambiente.sacvebio.cre.rue.client.UsuarioClient usClientRue;
    ...
    public ar.gob.ambiente.sacvebio.cre.entities.Domicilio getDomicilioLocal() {
        return domicilioLocal;
    }

    public void setDomicilioLocal(ar.gob.ambiente.sacvebio.cre.entities.Domicilio domicilioLocal) {    
    ...
    public void prepareDomDest(){
        domicilioLocal = new ar.gob.ambiente.sacvebio.cre.entities.Domicilio();
        cargarProvincias();
    }
    ...
    private void getTokenRue(){
        try{
            usClientRue = new ar.gob.ambiente.sacvebio.cre.rue.client.UsuarioClient();
